          ...
          >
            ...
            <td data-cell="watch specs" class="content__td--g">
              <ul class="content__specs content__specs--watch list-unstyled mb-0 small">
                ...
                <li><strong>Battery:</strong> ${variation.battery} mah</li>
            ...
            <td data-cell="base price" class="text-end">${variation.price_cents}</td>
            <td data-cell="sell price" class="text-end">${variation.base_price_cents}</td>
            <td data-cell="stock">
            ...
            <td data-cell="stop selling" class="text-center">${Boolean(variation.stop_selling)}</td>
            <td data-cell="actions">
              <div class="d-flex justify-content-center gap-1">
                ${
                  canUpdate
                    ? `<button
                        class="js-update-variation-btn btn btn-info btn-sm"
                      >
                ...
                ${
                  canDelete
                    ? `<button
                        class="js-delete-variation-btn btn btn-danger btn-sm"
                      >
...
async function renderUpdateVariationForm(number, id) {
 disableBgScroll();
 backdrop.html("<p class='text-center p-5'>Loading update variation form...</p>");
 backdrop.show();
...
function renderAddInstanceForm(variationNumber, variationId) {
  disableBgScroll();
  backdrop.html("<p class='text-center p-5'>Loading add instance form...</p>");
  backdrop.show();
