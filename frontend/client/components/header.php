    ...
    <nav class="navbar navbar-expand-lg shadow-sm">
        <div class="container-fluid">
            ...
            <div class="d-lg-none mb-3 d-flex justify-content-start mt-3">
                <div class="dropdown">
                    <i class="bi bi-person fs-3 me-3 cursor-pointer" id="userDropdown" data-bs-toggle="dropdown" data-bs-display="static" aria-expanded="false"></i>
            ...
            <div class="d-flex align-items-center">
                <form class="d-flex me-3 w-100" role="search">
                    <input class="form-control me-2" type="search" placeholder="Search" aria-label="Search" style="min-width: 200px">
