...
export default function renderUsersManagePage() {
  ...
  searchBtn.click(async e => {
    ...
    renderUsersCartData(filteredUsersList);
...
async function renderUsersCartData(usersList=null) {
  const tbody = $("#tbody");
    ...
    users.forEach((user, index) => {
      ...
      dataHTML += `
        <tr class="content__tr">
          ...
          <td data-cell="user(buyer) id" class="content__td" title="click to view user">${user.id}</td>
          <td data-cell="user email" class="content__td" title="${user.email}">email@gmail.com</td>
          <td data-cell="user cart" class="content__td">
            <ul class="content__items">
              <li class="content__item">
                <div class="item__detail">
                  <img class="item__img" src="./assets/product.png" alt="smartwatch">
                  <p>product name</p>
                  <p>-</p>
                  <p>133 &#162;</p>
                </div>
                <i class="uil uil-multiply"></i>
                <p class="item__quantity">15</p>
                <button class="item__btn">view detail</button>
              </li>
            </ul>
          </td>
          <td data-cell="actions" class="content__td">
